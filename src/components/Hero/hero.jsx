...
const Hero = () => {
  ...
  const roles = ["UI/UX Designer", "Content Creator", "Freelancer"]; // List of roles to rotate
      ...
      <div className="hero-content">
        ...
        <div className="hero-text">
          <p className="greeting">
            Hi! It's <span className="name">Heinrich</span>
          </p>
          <h1 className="title">
            I'm a <span className="dynamic-text">{text}</span>
            <span className="dot">.</span>
          </h1>
          <p className="description">
            I specialize in building interactive, dynamic websites with modern designs. Let's create
            something amazing together!
          </p>
          {/* Social Links */}
          <div className="social-links">
            <a href="https://github.com/RICHGCODE" target="_blank" rel="noopener noreferrer">
              <i className="bx bxl-github"></i>
            </a>
            <a
              href="https://www.linkedin.com/in/heinrich-castro/"
              target="_blank"
          ...
          <div className="hero-buttons">
            <a href="/Resume/Resume.docx" download className="btn btn-primary">
              Resume
            </a>
